//
//  AdministradorUsuariosViewController.swift
//  ReBUC PIM
//
//  Created by 7k on 16/11/17.
...
class AdministradorUsuariosViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
